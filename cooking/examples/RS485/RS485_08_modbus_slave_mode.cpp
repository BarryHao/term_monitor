...
void loop()
{
  ...
  regs[MB_0] = analogRead(1);  // Read input A1
  regs[MB_1] = analogRead(2);  // Read input A2
  regs[MB_2] = analogRead(3);  // Read input A3
  regs[MB_3] = analogRead(4);  // Read input A4
  regs[MB_4] = analogRead(5);  // Read input A5
